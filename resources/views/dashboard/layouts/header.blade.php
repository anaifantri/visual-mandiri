            ...
            <div class="flex items-center ml-2 px-2 w-full sm:max-w-[180px]">
                <a href="/dashboard/{{ $company->id }}" class="flex font-bold text-lg py-3">
                    <div
                        ...
                        <img class="sm:w-[26px] sm:h-[26px] flex m-auto" src="/img/visual-mandiri.png" alt="">
                    </div>
                    <span class="text-white mx-1">Visual</span>
                    <span class="text-red-500 mx-1">Mandiri</span>
                </a>
            </div>
            <!-- Logo & Tittle End-->
            <!-- Navbar Start-->
