                    ...
                    <div class="h-24">
                        <div class="flex w-full items-center px-10 pt-2 border-b pb-2">
                            ...
                            <div class="ml-4 w-[600px]">
                                ...
                                <span class="flex mt-1 text-xs">{{ $company->address }} - {{ $company->city }} |
                                    {{ $company->province }} -
                                    Indonesia</span>
                                <span class="flex mt-1 text-xs">Ph. {{ $company->phone }} | Mobile. {{ $company->m_phone }}
                                </span>
                        ...
                        <div class="flex w-full items-center px-10 pt-2 border-b pb-2">
                            ...
                            <div class="ml-4 w-[600px]">
                                ...
                                <span class="flex mt-1 text-xs">{{ $company->address }} - {{ $company->city }} |
                                    {{ $company->province }} -
                                    Indonesia</span>
                                <span class="flex mt-1 text-xs">Ph. {{ $company->phone }} | Mobile.
